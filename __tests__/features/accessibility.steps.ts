...
defineFeature(loadFeature("./accessibility.feature"), (test) => {
  ...
  testAccessibility(test, "Property occupation");
  testAccessibility(test, "Gas");
  testAccessibility(test, "Decoration pack");
  ...
  testAccessibility(test, "Queries about new home or estate");
